...
namespace XsensDOT_StandardLibrary
{
    public static class LibConstants
    {
        ...
        public static readonly Guid OrientationResetControlCharacteristicUuid = Guid.Parse("15172006-4947-11e9-8646-d663bd873d93");
        public static readonly Guid OrientationResetStatusCharacteristicUuid = Guid.Parse("15172007-4947-11e9-8646-d663bd873d93");
